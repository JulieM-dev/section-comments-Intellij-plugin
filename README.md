...
Inserts clean section separator comments that fill exactly to your right margin/hard wrap guide:
...
- Or Android Studio (!default margin is 100)
...
You can check your current right margin at **Editor → Code Style → Hard wrap**.
